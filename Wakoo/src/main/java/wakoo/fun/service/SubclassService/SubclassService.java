package wakoo.fun.service.SubclassService;
...
public interface SubclassService {
     ...
     * @return
     */
    Boolean insertSubclasss(Subclass subclass);
    /**
     * 查询是否查到有这个顺序
     * @return
     */
    Boolean getBySort(Integer sort,String typeName);
    /**
     ...
     * @return
     */
    Boolean updByIdSort(@Param("sort") Integer sort, @Param("id") Integer id);
    /**
     * 修改子类
     * @return
     */
